...
# Mendukung: AnyDesk, RustDesk, AnyViewer
# Pembaruan: Menggunakan logika asli cek_remote.ps1
# =====================================================================
...
if ($NeedUpdateWeekly) {$linesWeekly = [System.Collections.Generic.List[string]]::new()
    try {
        ...
        # 1. AnyDesk (Membaca file konfigurasi user dan sistem)
        ...
        # 2. RustDesk (Menjalankan perintah CLI dan membaca file TOML)
        $rd_exe = @(
        ...
        # 3. AnyViewer (Membaca Registry HKU/HKLM dan file konfigurasi INI)
        ...
        # Format output Checkmk dengan nama Remote_Apps
